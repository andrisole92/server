...
//         await User.remove({});
//     });
//     it('user can join the room if not banned', async () => {
//         try {
//             let r = await s.post('/room/join').send({uId: userId1, rId: roomId1});
//             console.log(r.body);
...
//         try {
//             let r = await s.post('/room/ban').send({uId: userId1, rId: roomId1});
//             console.log(r.body);
//             expect(r.statusCode).to.be.equal(200);
//             expect(r.body.s).to.be.a('boolean');
//             expect(r.body.s).to.be.equal(true);
...
//         try {
//             let r = await s.post('/room/unban').send({uId: userId1, rId: roomId1});
//             console.log(r.body);
//             expect(r.statusCode).to.be.equal(200);
//             expect(r.body.s).to.be.a('boolean');
//             expect(r.body.s).to.be.equal(true);
