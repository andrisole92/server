...
//         try {
//             let r = await s.post('/room/invite').send({uId: userId1, rId: roomId1, fId: userId2});
//             console.log(r.body);
...
//         try {
//             let r = await s.post('/room/block').send({uId: userId1, rId: roomId1});
//             console.log(r.body);
//             expect(r.statusCode).to.be.equal(200);
//             expect(r.body.s).to.be.a('boolean');
//             expect(r.body.s).to.be.equal(true);
...
//         try {
//             let r = await s.post('/room/invite').send({uId: userId1, rId: roomId1});
//             console.log(r.body);
//             expect(r.statusCode).to.be.equal(200);
//             expect(r.body.s).to.be.a('boolean');
//             expect(r.body.s).to.be.equal(true);
